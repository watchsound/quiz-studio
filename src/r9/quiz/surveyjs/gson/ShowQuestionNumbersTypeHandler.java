...
public class ShowQuestionNumbersTypeHandler implements JsonSerializer<ShowQuestionNumbersType>,  
       JsonDeserializer<ShowQuestionNumbersType> {  
 
   // 对象转为Json时调用,实现JsonSerializer<PackageState>接口  
   @Override  
   public JsonElement serialize(ShowQuestionNumbersType state, Type arg1,  
   ...
   @Override  
   public ShowQuestionNumbersType deserialize(JsonElement json, Type typeOfT,  
           JsonDeserializationContext context) throws JsonParseException {  
       if (json.getAsInt() < ShowQuestionNumbersType.values().length)  
           return ShowQuestionNumbersType.values()[json.getAsInt()];  
       return null;  
   }  
